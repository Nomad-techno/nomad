...
@section('content')
    <h1 class="text-center font-weight-bold text-secondary">Hello Category</h1>
    <div class="container">
        <div class="row">
            <p class="btn btn-success font-weight-bold"><a href="" class="font-weight"> Category <i class="fa fa-plus"></i></a></p>
        </div>
        <div class="row">
