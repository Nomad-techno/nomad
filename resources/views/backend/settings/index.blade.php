...
@section('content')
    ...
    <div class="container">
        <div class="row">
            <p class="btn btn-success font-weight-bold"><a href="" class="font-weight"> Settings <i class="fa fa-plus"></i></a></p>
        </div>
        <div class="row">
  ...
  <tbody>
    ...
    <tr>
      <td colspan="5" class="text-center font-weight-bold">Hozircha Settingsda hech narsa yoq</td>
    </tr>
  </tbody>
</table>
        </div>
